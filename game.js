class Game{
	...
	init() {
		...
		loader.load( `${this.assetsPath}Idle.fbx`, function ( object ) {

			object.mixer = new THREE.AnimationMixer( object );
			game.player.mixer = object.mixer;
			game.player.root = object.mixer.getRoot();
			
			object.name = "Volibear";
            ...
            tLoader.load(`${game.assetsPath}textures/voli_0.png`, function(texture){
				object.traverse( function ( child ) {
					if ( child.isMesh ){
    ...
    playerControl(forward, turn){
		...
		if (forward>0.3){
			if (this.player.action!='running') this.action = 'running';
		}else{
			forward = 0;
	...
	animate() {
        ...
        if (this.sun != undefined){
            ...
            this.sun.position.y = this.player.object.position.y + 400;
